...
class Player extends EventEmitter<IPublicAPIEvent> {
   ...
   */
  getAvailablePeriods() : IExposedPeriod[] {
    if (this._priv_contentInfos === null) {
      return [];
    }
    ...
    return this._priv_trackChoiceManager.getAvailablePeriods();
  }
   ...
   * @returns {Array.<Object>}
   */
  getAvailableAudioTracks(periodId? : string | undefined) : ITMAudioTrackListItem[] {
    if (this._priv_contentInfos === null) {
      return [];
    }
    ...
    if (this._priv_trackChoiceManager !== null) {
      ...
      if (wantedPeriodId !== undefined) {
        return this._priv_trackChoiceManager.getAvailableAudioTracks(wantedPeriodId);
      }
    }
    return [];
  }
   ...
   * @returns {Array.<Object>}
   */
  getAvailableTextTracks(periodId? : string | undefined) : ITMTextTrackListItem[] {
    if (this._priv_contentInfos === null) {
      return [];
    }
    const { currentPeriod, isDirectFile } = this._priv_contentInfos;
    ...
    if (this._priv_trackChoiceManager !== null) {
      const wantedPeriodId = periodId ?? currentPeriod?.id;
      if (wantedPeriodId !== undefined) {
        return this._priv_trackChoiceManager.getAvailableTextTracks(wantedPeriodId);
      }
    }
    return [];
  }
   ...
   * @returns {Array.<Object>}
   */
  getAvailableVideoTracks(periodId? : string | undefined) : ITMVideoTrackListItem[] {
    if (this._priv_contentInfos === null) {
      return [];
    }
    const { currentPeriod, isDirectFile } = this._priv_contentInfos;
    ...
    if (this._priv_trackChoiceManager !== null) {
      const wantedPeriodId = periodId ?? currentPeriod?.id;
      if (wantedPeriodId !== undefined) {
        return this._priv_trackChoiceManager.getAvailableVideoTracks(wantedPeriodId);
      }
    }
    return [];
  }
   ...
   */
  getAudioTrack(periodId? : string | undefined) : ITMAudioTrack|null|undefined {
    if (this._priv_contentInfos === null) {
      return undefined;
    }
    const { currentPeriod, isDirectFile } = this._priv_contentInfos;
    ...
    if (this._priv_trackChoiceManager !== null) {
      const wantedPeriodId = periodId ?? currentPeriod?.id;
      if (wantedPeriodId !== undefined) {
        return this._priv_trackChoiceManager.getChosenAudioTrack(wantedPeriodId);
      }
    }
    return undefined;
  }
   ...
   * @returns {Object|null|undefined}
   */
  getTextTrack(periodId? : string | undefined) : ITMTextTrack|null|undefined {
    if (this._priv_contentInfos === null) {
      return undefined;
    }
    const { currentPeriod, isDirectFile } = this._priv_contentInfos;
    ...
    if (this._priv_trackChoiceManager !== null) {
      const wantedPeriodId = periodId ?? currentPeriod?.id;
      if (wantedPeriodId !== undefined) {
        return this._priv_trackChoiceManager.getChosenTextTrack(wantedPeriodId);
      }
    }
    return undefined;
  }
   ...
   * @returns {Object|null|undefined}
   */
  getVideoTrack(periodId? : string | undefined) : ITMVideoTrack|null|undefined {
    if (this._priv_contentInfos === null) {
      return undefined;
    }
    const { currentPeriod, isDirectFile } = this._priv_contentInfos;
    ...
    if (this._priv_trackChoiceManager !== null) {
      const wantedPeriodId = periodId ?? currentPeriod?.id;
      if (wantedPeriodId !== undefined) {
        return this._priv_trackChoiceManager.getChosenVideoTrack(wantedPeriodId);
      }
    }
    return undefined;
  }
  ...
  setAudioTrack(audioId : string, periodId? : string | undefined) : void {
    ...
    const wantedPeriodId = periodId ?? currentPeriod?.id;
    if (wantedPeriodId !== undefined) {
      this._priv_trackChoiceManager.setAudioTrackByID(wantedPeriodId, audioId);
    }
  }
  ...
  setTextTrack(textId : string, periodId? : string | undefined) : void {
    ...
    const wantedPeriodId = periodId ?? currentPeriod?.id;
    if (wantedPeriodId !== undefined) {
      this._priv_trackChoiceManager.setTextTrackByID(wantedPeriodId, textId);
    }
  }
  ...
  disableTextTrack(periodId? : string | undefined) : void {
    ...
    const wantedPeriodId = periodId ?? currentPeriod?.id;
    if (wantedPeriodId !== undefined) {
      this._priv_trackChoiceManager.disableTextTrack(wantedPeriodId);
    }
  }
  ...
  setVideoTrack(videoId : string, periodId? : string | undefined) : void {
    ...
    const wantedPeriodId = periodId ?? currentPeriod?.id;
    if (wantedPeriodId !== undefined) {
      this._priv_trackChoiceManager.setVideoTrackByID(wantedPeriodId, videoId);
    }
  }
  ...
  disableVideoTrack(periodId? : string | undefined) : void {
    ...
    const wantedPeriodId = periodId ?? currentPeriod?.id;
    if (wantedPeriodId !== undefined) {
      this._priv_trackChoiceManager.disableVideoTrack(wantedPeriodId);
    }
  }
  ...
  private _priv_onManifestReady({ manifest } : { manifest : Manifest }) : void {
    ...
    // XXX TODO @instanciation?
    this._priv_trackChoiceManager.updatePeriodList(manifest.periods);
  ...
  private _priv_onActivePeriodChanged({ period } : { period : Period }) : void {
    ...
    if (this._priv_trackChoiceManager !== null) {
      // XXX TODO
      const audioTrack = this._priv_trackChoiceManager.getChosenAudioTrack(period.id);
      const textTrack = this._priv_trackChoiceManager.getChosenTextTrack(period.id);
      const videoTrack = this._priv_trackChoiceManager.getChosenVideoTrack(period.id);
    ...
    switch (type) {
      ...
      case "text":
        if (this._priv_trackChoiceManager === null) {
          ...
          this._priv_trackChoiceManager.addTrackChoiceSubject(type, period, adaptation$);
        }
        break;
    }
  }
  ...
  private _priv_onPeriodStreamCleared(value : {
    ...
    switch (type) {
      ...
      case "video":
        if (this._priv_trackChoiceManager !== null) {
          this._priv_trackChoiceManager.removeTrackChoiceSubject(type, period);
        }
        break;
    }
  ...
  private _priv_onReloadingMediaSource() {
    ...
    if (this._priv_trackChoiceManager) {
      this._priv_trackChoiceManager.resetSubjects();
    }
  }
      ...
      switch (type) {
        case "audio":
          const audioTrack = this._priv_trackChoiceManager
            .getChosenAudioTrack(currentPeriod.id);
          if (audioTrack !== undefined) {
            this.trigger("audioTrackChange", audioTrack);
          }
        ...
        case "text":
          const textTrack = this._priv_trackChoiceManager
            .getChosenTextTrack(currentPeriod.id);
          if (textTrack !== undefined) {
            this.trigger("textTrackChange", textTrack);
          }
          break;
        case "video":
          const videoTrack = this._priv_trackChoiceManager
            .getChosenVideoTrack(currentPeriod.id);
          if (videoTrack !== undefined) {
            this.trigger("videoTrackChange", videoTrack);
          }
